...
const Regulation = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (regulationData._id) {
        // 🟢 UPDATE EXISTING DATA
        const response = await axios.put(`http://localhost:5001/Regulations/${regulationData._id}`, formData, {
          headers: {
      ...
      getRegulationInfo(); // Refresh the data after adding/updating
